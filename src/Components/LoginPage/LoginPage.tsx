...
export default function LoginPage() {
    ...
    const googleLogin = () => {
        window.open("https://oauth-boilerplate-backend.herokuapp.com/auth/google", "_self");
    }

    const githubLogin = () => {
        window.open("https://oauth-boilerplate-backend.herokuapp.com/auth/github", "_self");
    }
    
    const twitterLogin = () => {
        window.location.href = "https://oauth-boilerplate-backend.herokuapp.com/auth/twitter"
    }
